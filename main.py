...
(compute_transition_prob,compute_emission_prob,x_train,x_test,y_train,y_test) = readFile.get_parameters()

model = hmm_scaled.HmmScaled(compute_transition_prob,compute_emission_prob,'random_model.json')
