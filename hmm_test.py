...
for test_rec in test_data:
    ...
    print ('VITERBI: Predict the next state')
    next_state = test_hmm.predict_state(state_sequence)
    print ('  Current state: ', state_sequence[0])
    print ('  Predicted next state: ', next_state)
    print ('  Real next state: ', state_sequence[1])
    print ('')
